return {
  {
    ...
    opts = {
      ...
      quickfile = { enabled = true }, -- will render the file as quickly as possible, before loading your plugins.
      scope = { enabled = false }, --Scope detection based on treesitter or indent.
      scroll = { enabled = true }, -- Smooth scrolling for Neovim. Properly handles scrolloff and mouse scrolling.
