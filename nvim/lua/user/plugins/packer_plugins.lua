...
return packer.startup(function(use)
	...
	use("j-hui/fidget.nvim") --nvim progress eye candy

	use("b0o/SchemaStore.nvim") --js json lsp
	use("ray-x/lsp_signature.nvim") --show func def when typing
	...
	use({ "WhoIsSethDaniel/toggle-lsp-diagnostics.nvim", commit = "a7839742dadf90177f3a9ea4747e79f404d10af3" }) -- toggle diagnostic
	...
	use("windwp/nvim-ts-autotag") --treesitter autotag
